<!--aula 06 00:55:15, todo codigo esta lá-->
<?php
...
<!--<h1 class="breadcrumb">"olha o que temos: ".<?php /* echo ($_SESSION['login_usuario'].$_SESSION['nivel_usuario'].$_SESSION['nome_da_sessao']); */?></h1>-->
